...
# Parâmetros da fonte para garantir consistência com o Lumerical
C_LIGHT = 299792458.0
WL_START, WL_STOP = 1.45e-6, 1.62e-6
F_STOP, F_START = C_LIGHT / WL_START, C_LIGHT / WL_STOP # Invertido para frequência

# Parâmetros para o pulso gaussiano de teste em Python
GAUSSIAN_CENTER_FREQ = (F_START + F_STOP) / 2
GAUSSIAN_FWHM = F_STOP - F_START
...
try:
    ...
    for gen_num in range(num_generations):
        ...
        gen_fitness = calculate_fitness_for_generation(
            total_S_matrices=total_S_matrices,
            frequencies=frequencies,
            gaussian_center_freq=GAUSSIAN_CENTER_FREQ,
            gaussian_fwhm=GAUSSIAN_FWHM,
            plot_best_spectrum=plot_best_spectrum,
            generation_num=generations_processed,
            output_directory=_simulation_spectra_directory
        )
